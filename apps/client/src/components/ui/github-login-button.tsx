...
export function GitHubLoginButton({ className }: GitHubLoginButtonProps) {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className={cn(
        'flex items-center justify-center gap-2 rounded-md bg-[#24292F] px-4 py-2 text-sm font-medium text-white hover:bg-[#24292F]/90 focus:outline-none focus:ring-2 focus:ring-[#24292F]/50 disabled:opacity-50 disabled:cursor-not-allowed',
        className
      )}
    >
      <svg
