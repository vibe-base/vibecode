...
print("Script created. Run the following command to execute it in the FastAPI pod:")
print("kubectl exec -n vibecode $(kubectl get pods -n vibecode -l app=fastapi -o name | head -n 1) -- python -c \"$(cat db_script.py)\"")
