...
// Import middlewares
const catchAllRouter = require('./catch-all');
...
// Use catch-all router (must be first to log all requests)
app.use(catchAllRouter);

// Use mock auth middleware
app.use(mockAuthRouter);

// Use projects mock router
...
# Copy the catch-all router
cp express-catch-all.js express-auth-temp/catch-all.js
